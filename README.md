...
| 4 | Estimation for MVN models <br> Gaussian Processes: basic definitions and examples      | notes4 <br> [slides4](./slides/slides_GPs.pdf)| DL: [tut4](./tutorials/tutorial4.Rmd)  | 29 Jan |  |
