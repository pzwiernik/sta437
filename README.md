...
| 3 | MVN: Conditional distribution, conditional independence. <br> Estimation for MVN models    | [notes3](./lectures/lecture3.pdf) | LSM: [tut3](./tutorials/tutorial3.pdf)<br> [code](./tutorials/tutorial3.hmtl) | 22 Jan |   |
